...
// CalcAndMat.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "CalcAndMat.h"
#include "CalcAndMatDlg.h"
...
BEGIN_MESSAGE_MAP(CCalcAndMatApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCalcAndMatApp

CCalcAndMatApp::CCalcAndMatApp()
{
...
// Единственный объект CCalcAndMatApp

CCalcAndMatApp theApp;


// Инициализация CCalcAndMatApp

BOOL CCalcAndMatApp::InitInstance()
{
